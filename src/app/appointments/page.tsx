...
const AppointmentsPage = () => {
  // state management for the booking proces - this could be done with something like zustand for larger apps
  ...
  const [currentStep, setCurrentStep] = useState(1); // step 1 select dentist, step 2: select time, step 3 confirm
  ...
  return (
    <>
      ...
      {/* Show existign appointments for the current user */}
