    ...
    <section className="relative py-32 px-6 overflow-hidden bg-linear-to-b from-background to-muted/20">
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/5 to-primary/10 rounded-full border border-prmary/10 backdrop-blur-sm mb-6">
            <MessageCircleCodeIcon className="size-4 text-primary" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
                ...
                <div className="bg-linear-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-3 flex-1">
                      <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
                        <p className="font-semibold text-primary">
                          "How much does tech whitening cost?"
                        </p>
                      </div>
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Compare treatement options, pricing ranges, and find
              ...
              {/* Chat Bubble 3 */}
              <div className="group relative">
                <div className="bg-linear-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transiton-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    <div className="size-12 bg-linear-to-br from-primary/20 to-primary/10 rounded-2xl flex items-center justify-center shrink-0">
                      <MessageSquare className="size-6 text-primary" />
                    </div>
                    <div className="space-y-3 flex-1">
                      ...
                      <div className="bg-muted/30 rounded-2xl p-4">
                        ...
                        <div className="flex gap-2 mt-3">
                          <span className="px-2 py1 bg-primary/10 text-primary text-xs rounded-full">
                            Preventive Care
                          </span>
                          <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">
                            Maintenance
