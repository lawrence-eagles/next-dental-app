      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
            ...
            <div className="relative z-10 flex items-center justify-between">
              ...
              <div className="hidden lg:block">
                <div className="size-32 bg-linear-to-br from-primary/20 to-primary/10 rounded-full flex items-center justify-center">
                  <MicIcon className="size-16 text-primary" />
                </div>
              </div>
            </div>
          </div>
        ...
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 max-w-2xl mx-auto">
          <CardContent className="relative p-8 text-center">
            <div className="size-20 bg-linear-to-br from-primary/20 to-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <Link href={"/pro"}>
              <Button className="w-full bg-linear-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                <CrownIcon className="mr-2 size-5" />
                Upgrade to Pro
              </Button>
            </Link>
          </CardContent>
